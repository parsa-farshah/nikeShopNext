...
function Header() {
  ...
  return (
    <header
      className={`w-full h-[52px] md:h-[113px] px-4 md:px-[50px] flex justify-between items-center ${
        oxanium.className
    ...
    >
      ...
      <div
        className={` ${theme === "light" ? "bg-white" : "bg-black"}
          ${
            menuMobile
              ? "w-[102%] fixed top-0 left-0 h-screen overflow-y-auto z-20 flex flex-col justify-start px-4 md:px-[50px] pt-7 duration-300"
      ...
      >
        <div className="w-full flex justify-between">
          ...
          <X
            className={`cursor-pointer hover:rotate-180 duration-300  ${
      ...
      >
        ...
        <input
          ...
          id="search"
          placeholder="Search"
          className={` mt-10 px-5 outline-0 ${
            theme === "light"
              ? " caret-black text-black text-4xl placeholder:text-black"
              : "caret-white text-white text-4xl placeholder:text-white"
          }`}
        />
        {/* data get search */}
